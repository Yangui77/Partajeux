...
% captures d'écran
Cette partie devra contenir un bref descriptif de l'application pour l'utilisateur
final : description des menus et principales fonctionnalités. Vous pourrez y
ajouter éventuellement des copies d'écran
