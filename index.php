...
if(isset($_POST['Fomulaire_inscription'])){
...
include($_SERVER['DOCUMENT_ROOT'].'/Partajeux/controleur/controleur_echange.php');
...
include($_SERVER['DOCUMENT_ROOT'].'/Partajeux/controleur/controleur_accueil.php');
include($_SERVER['DOCUMENT_ROOT'].'/Partajeux/controleur/controleur_echange_jeux.php');
include($_SERVER['DOCUMENT_ROOT'].'/Partajeux/controleur/controleur_transaction.php');
}
